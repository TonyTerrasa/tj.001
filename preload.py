...
cs_base_color = "#7526AF"  # the base color
cs_header = "TJ.001"  # the upper-left corner
cs_icon_url = 'COURSE/favicon_local.gif'  # the favicon, if any
# the 'header' text for the page
cs_long_name = cs_content_header = ""
cs_title = ''  # the browser's title bar
...
cs_top_menu = [
    ...
    {'text': 'Pages', 'link': [
                                {'text': 'Sample English Questions', 'link': 'COURSE/english-questions'},
                                {'text': 'Markdown', 'link': 'COURSE/markdown'},
                                {'text': 'Question Help', 'link': 'COURSE/questions-from-sample'},
